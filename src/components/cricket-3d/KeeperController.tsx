...
export const KeeperController = forwardRef<KeeperControllerHandle, KeeperControllerProps>(
  function KeeperController({ name = 'J Smith', jerseyColor, trouserColor, modelUrl }, ref) {
    ...
    return (
      <group ref={groupRef}>
        <PlayerModel ref={playerRef} role="keeper" jerseyColor={jerseyColor} trouserColor={trouserColor} label={name} modelUrl={modelUrl} />
      </group>
    );
  },
);
